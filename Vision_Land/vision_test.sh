...
--tab -e 'bash -c "sleep 5; roslaunch mavros px4.launch fcu_url:="/dev/ttyTHS1:921600" gcs_url:="udp://@192.168.82.204"; exec bash"' \
...
--tab -e 'bash -c "sleep 7; roslaunch px4_command vision_test_0603.launch; exec bash"' \
